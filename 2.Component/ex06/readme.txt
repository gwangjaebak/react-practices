...
1) this.state를 직접 조작하는 것은 React 상태관리를 우회하는 것!(리액트 프로그래밍 모델에 반하는 것이다.)
2) 성능 개선의 여지가 없어진다.
    - 객체의 변경 유무를 검사시 객체의 동질성 비교는 고비용
    - 객체의 변경 유무를 검사시 객체의 동일성 비교는 저비용[ex) object1 === object2]
3) 결론은 "변경하지 말고 대체하라!"

HowI:
1. 비파괴 배열 메서드 및 연산자: map, filter, reduce, concat, ...(ES6 spread 연산자 활용)
2. src/01 참고