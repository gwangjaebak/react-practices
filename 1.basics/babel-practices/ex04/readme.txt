...
=======
1. 여러 플러그인의 변환 규칙을 한번에 적용하기 위해 미리 관련 플러그인들을 모아놓은 것.
2. ECMAScript 년도별(버전별)로 모아놓은 것들
   stage(0, 1, 2, 3) 레벨로 모아놓은 것들
   3rd party(typescript, react)
   등 종류가 다양하다.
3. Env Preset은 stage 3레벨 이상의 문법들을 적용하는 플러그인
